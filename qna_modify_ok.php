...
if ($title && $content){
    $sql = mc("UPDATE qna_board SET title='$title', content='$content', file='$filename' WHERE idx='$bno'");
    if ($sql) {
        echo "<script>alert('글 수정이 완료되었습니다.'); location.href='qna_detail.php?idx=$bno';</script>";
    } else {
